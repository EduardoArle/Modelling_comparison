...
#load variables 2041-2060, MIROC6, RCP 4.5
setwd(wd_raw_vars)

vars_mir_4.5_2050 <- rast('wc2.1_2.5m_bioc_MIROC6_ssp245_2041-2060.tif')


names(vars_mir_4.5_2050) <- c('bio1', 'bio2', 'bio3', 'bio4', 'bio5', 'bio6',
                              'bio7', 'bio8', 'bio9', 'bio10', 'bio11', 'bio12',
                              'bio13', 'bio14', 'bio15', 'bio16', 'bio17',
                              'bio18', 'bio19')
...
#fix extent issue (lu ended up not having Antarctica)
vars_mir_4.5_2050 <- crop(vars_mir_4.5_2050, lu_4.5_2050)

#make a list 
all_vars <- c(vars_mir_4.5_2050, lu_4.5_2050) 
...
#load variables 2041-2060, MIROC6, RCP 8.5
setwd(wd_raw_vars)

vars_mir_8.5_2050 <- rast('wc2.1_2.5m_bioc_MIROC6_ssp585_2041-2060.tif')


names(vars_mir_8.5_2050) <- c('bio1', 'bio2', 'bio3', 'bio4', 'bio5', 'bio6',
                              'bio7', 'bio8', 'bio9', 'bio10', 'bio11', 'bio12',
                              'bio13', 'bio14', 'bio15', 'bio16', 'bio17',
                              'bio18', 'bio19')
...
#fix extent issue (lu ended up not having Antarctica)
vars_mir_8.5_2050 <- crop(vars_mir_8.5_2050, lu_8.5_2050)

#make a list 
all_vars <- c(vars_mir_8.5_2050, lu_8.5_2050) 
...
#load variables 2081-2100, MIROC6, RCP 4.5
setwd(wd_raw_vars)

vars_mir_4.5_2090 <- rast('wc2.1_2.5m_bioc_MIROC6_ssp245_2081-2100.tif')


names(vars_mir_4.5_2090) <- c('bio1', 'bio2', 'bio3', 'bio4', 'bio5', 'bio6',
                              'bio7', 'bio8', 'bio9', 'bio10', 'bio11', 'bio12',
                              'bio13', 'bio14', 'bio15', 'bio16', 'bio17',
                              'bio18', 'bio19')
...
#fix extent issue (lu ended up not having Antarctica)
vars_mir_4.5_2090 <- crop(vars_mir_4.5_2090, lu_4.5_2090)

#make a list 
all_vars <- c(vars_mir_4.5_2090, lu_4.5_2090) 
...
#load variables 2081-2100, MIROC6, RCP 8.5
setwd(wd_raw_vars)

vars_mir_8.5_2090 <- rast('wc2.1_2.5m_bioc_MIROC6_ssp585_2081-2100.tif')


names(vars_mir_8.5_2090) <- c('bio1', 'bio2', 'bio3', 'bio4', 'bio5', 'bio6',
                              'bio7', 'bio8', 'bio9', 'bio10', 'bio11', 'bio12',
                              'bio13', 'bio14', 'bio15', 'bio16', 'bio17',
                              'bio18', 'bio19')
...
#fix extent issue (lu ended up not having Antarctica)
vars_mir_8.5_2090 <- crop(vars_mir_8.5_2090, lu_8.5_2090)

#make a list 
all_vars <- c(vars_mir_8.5_2090, lu_8.5_2090) 
